...
def _lanes(python=False, frontend=False, site=False, scan=False, deps=False, uv_lock=False, npm_lock=False, installer=False, desktop_updater=False, rust=False, mcp_catalog=False, docker_meta=False, installers=False, ci_review=False, python_prod=None, nix=None, docker=None) -> dict[str, bool]:
...
CASES = {
    ...
    "PowerShell installer → installers": (
        ["scripts/install.ps1"],
        _lanes(python=True, installer=True, installers=True),
    ),
