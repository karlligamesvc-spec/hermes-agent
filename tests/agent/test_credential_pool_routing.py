...
class TestFailureAttribution:
    ...
    def _make_pool(self, tmp_path, monkeypatch, entries):
        # Pool loading also discovers Claude Code credentials from the real
        # user home. Keep this regression fixture hermetic so a developer who
        # is logged into Claude does not silently gain a second pool entry.
