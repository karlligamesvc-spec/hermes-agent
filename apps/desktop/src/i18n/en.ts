...
export const en: Translations = {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting APEX Desktop.',
    ...
    native: {
      ...
      inputBody: 'APEX is waiting for your response.',
      turnDoneTitle: 'APEX finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to APEX defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while APEX is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'APEX asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while APEX was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'APEX checks for updates automatically in the background and lets you know when one is ready.',
    ...
    gateway: {
      ...
      intro:
        'APEX Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running APEX backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      cloudTitle: 'APEX website',
      cloudDesc: 'Open the APEX website to sign in and manage your account and cloud services.',
      ...
      sshDesc:
        'APEX starts on the remote host over SSH and tunnels back to this app. Requires working key-based SSH access to the host.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. APEX starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build APEX ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. APEX runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    sharedGatewayRestarted: count => `Shared gateway restarted (${count} ${count === 1 ? 'assistant' : 'assistants'})`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent APEX environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. APEX will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    wakeWordListening: _phrase => 'APEX voice activation — listening',
    wakeWordOff: _phrase => 'APEX voice activation — off',
    wakeWordPausedVoice: _phrase => 'APEX voice activation — paused during voice chat',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of APEX can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of APEX is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected APEX backend is ready to install.',
  ...
  onboarding: {
    ...
    authorizeThere: 'Authorize APEX there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize APEX there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'APEX inference gateway status',
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'APEX is restarting...',
      askRestart: 'Ask APEX to restart the server',
      ...
      blankPageBody: 'Type an address above to browse, or ask APEX to open a page.',
      finishedRestarting: message => `APEX finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'APEX could not restart the server.',
      stillWorking:
        'APEX is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). APEX won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'APEX needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'APEX needs a credential to continue.',
    ...
    vaultUnlockDesc: name =>
      `APEX wants to use a login saved in ${name}. Enter the master password to unlock it for this session; it stays on this machine and is never shown to the model.`,
    ...
    vaultSaveDesc: origin =>
      `APEX reached a sign-in page at ${origin} and has no saved login. Enter it once here; it is encrypted on this machine and filled without exposing the password to the model.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code. Enter it here and APEX types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote: 'Save the authenticator key with this login to let APEX enter future codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart APEX Desktop to use Save Image.',
    restartToSaveImages: 'Restart APEX Desktop to save images',
  ...
  businessWorkspace: {
    goalLauncher: {
      confirmationEyebrow: 'Ready to start',
      confirmationExecutor: 'Executor: Hermes',
    ...
    projects: {
      ...
      runStatusUnavailable: 'Run status is unavailable',
      ...
      availableSources: 'App connections',
      sourceConnected: 'Connected',
      sourceNotConnected: 'Not connected',
      noAvailableSources: 'There are no app connections to manage yet.',
    ...
    workflows: {
      ...
      homeSourceCoverage:
        'Douyin, Xiaohongshu, WeChat Channels, Kuaishou, Bilibili, YouTube, TikTok, and Instagram. You can also upload a video directly.',
      additionalTitle: 'More business paths',
      pathCount: count => `${count} ${count === 1 ? 'path' : 'paths'}`,
      homePaths: {
        videoTranscript: {
          title: 'Download and transcribe a video',
          summary: 'Paste a link to save the video and create captions, a transcript, and time-coded text.',
          prompt:
        ...
        socialIntelligence: {
          ...
          summary: 'Combine public data, comments, and engagement trends into opportunities and next steps.',
          prompt:
    ...
    workflowDomain: {
      ...
      deliverables: {
        actionFailed: 'The review was not saved. Your note is still here; try again.',
        all: 'All',
        approve: 'Approve this result',
        back: 'Back to deliverables',
        citationCoverage: 'Citation coverage',
        content: 'Content',
        copy: 'Copy',
        created: 'Created',
        description: 'Review, verify, and approve real business results produced by Hermes.',
        detailEyebrow: 'Real business result',
        detailTitle: 'Deliverable details',
        emptyDescription: 'Deliverables appear here after Hermes saves a real result.',
        emptyTitle: 'No deliverables yet',
        evidence: 'Evidence and verification',
        evidenceCount: count => `${count} evidence ${count === 1 ? 'item' : 'items'}`,
        filterEmpty: 'No deliverables match this filter.',
        filters: 'Deliverable type',
        highlights: 'Key findings',
        itemCount: count => `${count} ${count === 1 ? 'deliverable' : 'deliverables'}`,
        kind: kind =>
          ({ copy: 'Copy', material: 'Asset', media: 'Asset', report: 'Report', sheet: 'Spreadsheet' })[kind] || kind,
        loadFailedDescription: 'The request failed. Session attachments and mock data are not used as substitutes.',
        loadFailedTitle: 'Deliverables unavailable',
        loadMore: 'Load more',
        loading: 'Loading deliverables',
        loadingMore: 'Loading…',
        material: 'Assets',
        noEvidence: 'No public evidence is available for this result.',
        noReviews: 'No review decisions yet.',
        notVerified: 'Needs verification',
        open: 'Open result',
        openFailed: 'The file could not be opened. Try again later.',
        openUnavailable: 'No file is available to open',
        project: 'Project',
        refresh: 'Refresh',
        report: 'Reports',
        requestChanges: 'Request changes',
        reviewNote: 'Revision note',
        reviewNotePlaceholder: 'Describe what should change, the evidence, or the expected result',
        reviewNoteRequired: 'Add a revision note.',
        reviewRound: round => `Round ${round}`,
        ...
        title: 'Deliverables',
        unavailableDescription: 'This Desktop or the production API has not enabled Phase 2 reads.',
        unavailableTitle: 'Live deliverables are not connected',
        updated: 'Updated',
        verifier: 'Verification',
        verificationChecked: 'Checked',
        verificationOutcome: 'Outcome',
        verificationReason: 'Verification note',
        verified: 'Verified',
        view: 'View details',
        workflow: 'Workflow'
      },
      history: {
        all: 'All',
        deliverables: 'Deliverables',
        description: 'Review runs, results, and decisions over time. Every entry targets a real object.',
        emptyDescription: 'Lifecycle entries appear here after a real workflow starts.',
        emptyTitle: 'No history yet',
        eyebrow: 'Business activity',
        filterEmpty: 'No activity matches this filter.',
        filters: 'History type',
        kind: kind => ({ deliverable: 'Deliverable', review: 'Review', run: 'Run' })[kind] || kind,
        loadFailedDescription: 'The request failed. Session search is not used as a substitute for business history.',
        loadFailedTitle: 'History unavailable',
        loadMore: 'Load more',
        ...
        title: 'History',
        today: 'Today',
        unavailableDescription: 'This Desktop or the production API has not enabled live Activity reads.',
        unavailableTitle: 'Live history is not connected',
        yesterday: 'Yesterday'
      },
      run: {
