...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        title: '寵物',
        intro:
          '領養一隻懸浮在應用上的 petdex 動畫寵物，它會根據 APEX 的狀態做出反應——工具執行時奔跑、成功時歡呼、出錯時沮喪。',
        restartHint: '寵物功能需要重新啟動——目前執行的應用在此功能加入前啟動。請結束並重新開啟 APEX，然後回到此處。',
        scaleTitle: '大小',
    ...
    gateway: {
      ...
      cloudTitle: 'APEX 官方網站',
      cloudDesc: '開啟 APEX 官方網站，登入並管理您的帳戶與雲端服務。',
      sshTitle: '透過 SSH 連線',
      sshDesc: '透過 SSH 在遠端主機啟動 APEX，並安全連線回桌面端。需要已設定好金鑰登入。',
    ...
    model: {
      ...
      noModels: '還沒有可用模型,請在「設定 › 提供方」中新增。',
      tasks: {
    ...
    providers: {
      ...
      localEndpoint: {
        title: '本地 / 自訂端點',
        description: '將 APEX 指向任意 OpenAI 相容端點（Zyphra、vLLM、llama.cpp、Ollama 等）。'
      },
      loading: '正在載入提供方...'
    },
    sessions: {
  ...
  starmap: {
    ...
    loading: '載入中…',
    emptyTitle: '尚無學習內容',
    emptyDesc: '當 APEX 為你的工作建立技能與記憶時，會顯示在這裡。'
  },
  agents: {
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: '請重新啟動 APEX 以使用寵物功能。',
      empty: '沒有符合的寵物。',
      turnOff: '關閉',
      turnOn: '開啟',
      installed: '已安裝',
    ...
    generatePet: {
      ...
      staleBackend: '請更新 APEX 以生成寵物。',
      backgroundHint: '你可以關閉此視窗——完成後 APEX 會通知你。',
    ...
    checkingDesktopUpdate: '正在檢查更新…',
    desktopUpdateReady: 'APEX 應用程式或 AI 引擎更新已就緒。',
    desktopUpdatePreparing: '正在準備 APEX 更新…',
    desktopUpdateNeedsShell: 'AI 引擎更新需要較新版本的 APEX 應用程式。',
    desktopUpdateCheckFailed: '無法檢查 APEX 應用程式更新。',
    desktopUpToDate: 'APEX 應用程式和 AI 引擎均為最新版本。',
    actionRunning: '執行中',
    actionDone: '完成',
    actionFailed: '失敗',
  ...
  sidebar: {
    ...
    projects: {
      ...
      createFailed: '無法建立專案',
      staleBackend: '請更新 APEX 後端以建立專案——目前後端比桌面應用舊（設定 → 更新 → 後端）。',
      deleteConfirm: '這會從 APEX 中移除已儲存的專案。檔案、git 儲存庫和工作樹維持不變。',
      startWork: '新增工作樹',
    ...
    desktopUpdate: {
      preparingTitle: version => (version ? `正在準備 APEX ${version}` : '正在準備 APEX 更新'),
      downloadedPercent: percent => `已下載 ${percent}%`,
      readyTitle: 'APEX 更新已準備好',
      appAndEngine: (appVersion, engineVersion) => `應用程式 ${appVersion} + ${engineVersion}`,
      appOnly: version => `應用程式 ${version}`,
      engineOnly: version => version,
      installRestart: '安裝並重新啟動',
      installing: '正在準備更新…',
      confirmTitle: '安裝 APEX 更新？',
      confirmBody: 'APEX 會在可用時一起更新應用程式與 AI 引擎，並只完整重新啟動一次。你的設定與工作不會遺失。',
      confirmApply: '安裝更新'
    }
  },
  ...
  updates: {
    ...
    guiSkewBody:
      '後端已更新，但此桌面應用程式套件未變更。請更新或重新安裝 APEX 桌面應用程式（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '複製',
    copied: '已複製',
    done: '完成',
    applyingBody: 'APEX 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 APEX。更新期間請勿自行重新開啟 APEX。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 APEX 會自動重新連線。',
    applyingClose: '此視窗會在更新期間關閉，隨後 APEX 會自動重新開啟。',
    errorTitle: '更新未完成',
  ...
  install: {
    ...
    reloadRetry: '重新載入並重試',
    stageLabels: {
      desktop_update_check: '檢查更新',
      shell_download: '應用程式安裝包',
  ...
  scenarios: {
    ...
    heartbeatAgo: seconds => {
      ...
      if (seconds < 3600) {
        return `心跳 ${Math.floor(seconds / 60)} 分鐘前`
      }
  ...
  businessWorkspace: {
    goalLauncher: {
      confirmationEyebrow: '啟動前確認',
      confirmationExecutor: '執行器：Hermes',
    ...
    projects: {
      ...
      detailTitle: '專案概覽',
      detailEyebrow: '專案概覽',
      detailUnavailableTitle: '專案詳情暫時無法使用',
      detailUnavailableDescription: 'APEX 無法讀取此專案。沒有資料被取代；請返回專案頁後重試。',
      loadingProjectDetail: '正在讀取專案詳情…',
      backToProjects: '返回專案',
      createdAtLabel: '建立時間',
      updatedAtLabel: '最近更新',
      currentRunTitle: '目前執行',
      runStatusUnavailable: '執行狀態暫時無法讀取',
      noRunTitle: '此專案尚未啟動執行',
      noRunDescription: '沒有 Run、Step 或進度可顯示。可繼續此目標，並在開始頁確認後啟動。',
      runSummaryUnavailableTitle: '執行摘要暫時無法使用',
      runSummaryUnavailable: '專案詳情已讀取，但目前介面沒有提供執行摘要。這裡不會猜測進度。',
      continueGoal: '繼續此目標',
      viewProject: '查看專案',
    ...
    workflowDomain: {
      ...
      deliverables: {
        ...
        copy: '文案',
        created: '建立時間',
        description: '查看、驗證並確認 Hermes 產生的真實業務成果。',
        detailEyebrow: '真實業務成果',
        detailTitle: '交付物詳情',
        emptyDescription: 'Hermes 儲存真實成果後，它們會顯示在這裡。',
        emptyTitle: '尚無交付物',
        evidence: '證據與驗證',
        evidenceCount: count => `${count} 條證據`,
        filterEmpty: '此篩選條件下沒有交付物。',
        filters: '交付物類型',
        highlights: '關鍵結論',
        itemCount: count => `${count} 份交付物`,
        kind: kind => ({ copy: '文案', material: '素材', media: '素材', report: '報告', sheet: '表格' })[kind] || kind,
        loadFailedDescription: '讀取失敗；不會以會話附件或模擬資料替代真實交付物。',
        loadFailedTitle: '交付物暫時不可用',
        loadMore: '載入更多',
        loading: '正在讀取交付物',
        loadingMore: '正在載入…',
        material: '素材',
        noEvidence: '這份成果沒有可顯示的公開證據。',
        noReviews: '尚無審閱記錄。',
        notVerified: '需要驗證',
        open: '開啟成果',
        openFailed: '檔案暫時無法開啟，請稍後重試。',
        openUnavailable: '目前沒有可開啟檔案',
        project: '所屬專案',
        refresh: '重新整理',
        report: '報告',
        requestChanges: '需要修改',
        reviewNote: '修改說明',
        reviewNotePlaceholder: '說明需要調整的內容、依據或期望結果',
        reviewNoteRequired: '請填寫修改說明。',
        reviewRound: round => `第 ${round} 輪`,
        reviews: '審閱記錄',
        run: '關聯執行',
        sheet: '表格',
        sourceCaptured: '來源擷取時間',
        status: status =>
          ({
            approved: '已確認',
        ...
        summary: '成果摘要',
        title: '交付物',
        unavailableDescription: '目前 Desktop 或正式環境 API 尚未啟用 Phase 2 讀取能力。',
        unavailableTitle: '真實交付物尚未連線',
        updated: '更新時間',
        verifier: '驗證結果',
        verificationChecked: '檢查時間',
        verificationOutcome: '驗證結論',
        verificationReason: '驗證說明',
        verified: '已驗證',
        view: '查看詳情',
        workflow: '工作流程'
      },
      history: {
        all: '全部',
        deliverables: '交付',
        description: '按時間回看執行、成果與確認記錄；每筆記錄都指向真實物件。',
        emptyDescription: '開始真實工作流程後，生命週期記錄會顯示在這裡。',
        emptyTitle: '尚無歷史記錄',
        eyebrow: '業務活動',
        filterEmpty: '此篩選條件下沒有記錄。',
        filters: '歷史類型',
        kind: kind => ({ deliverable: '交付', review: '確認', run: '執行' })[kind] || kind,
        loadFailedDescription: '讀取失敗；不會以會話搜尋結果替代真實業務歷史。',
        loadFailedTitle: '歷史暫時不可用',
        loadMore: '載入更多',
        loading: '正在讀取歷史',
        loadingMore: '正在載入…',
        noSummary: '沒有額外摘要。',
        ...
        title: '歷史',
        today: '今天',
        unavailableDescription: '目前 Desktop 或正式環境 API 尚未啟用真實 Activity 讀取能力。',
        unavailableTitle: '真實歷史尚未連線',
        yesterday: '昨天'
      },
      run: {
