...
export const ja = defineLocale({
  ...
  settings: {
    ...
    model: {
      ...
      noModels: '利用可能なモデルがまだありません。「設定 › プロバイダー」で追加してください。',
      tasks: {
  ...
  install: {
    ...
    finishingTitle: '仕上げ中',
    failedDesc:
      'インストール手順のいずれかが失敗しました。別の APEX CLI またはデスクトップインスタンスが実行中の場合は閉じてから再試行してください。詳細は以下またはデスクトップログで確認できます。',
    activeDesc:
  ...
  businessWorkspace: {
    ...
    workflows: {
      ...
      homePaths: {
        ...
        viralRemake: {
          ...
          prompt:
            'この人気ショート動画を分析し、構成とテンポを参考に、私が提供する、または使用許諾を得た素材で編集可能なオリジナル動画を制作してください。完成動画と編集可能なプロジェクトを納品し、素材が不足する場合は必要なものを教えてください。'
        },
        socialIntelligence: {
    ...
    workflowDomain: {
      ...
      deliverables: {
        actionFailed: 'レビューを保存できませんでした。メモは保持されています。もう一度お試しください。',
        all: 'すべて',
        approve: 'この成果を承認',
        back: '成果物に戻る',
        citationCoverage: '引用カバレッジ',
        content: '内容',
        copy: 'コピー',
        created: '作成日時',
        description: 'Hermes が生成した実際の業務成果を確認、検証、承認します。',
        detailEyebrow: '実際の業務成果',
        detailTitle: '成果物の詳細',
        emptyDescription: 'Hermes が実際の成果を保存すると、ここに表示されます。',
        emptyTitle: '成果物はまだありません',
        evidence: '根拠と検証',
        evidenceCount: count => `${count} 件の根拠`,
        filterEmpty: 'このフィルターに一致する成果物はありません。',
        filters: '成果物の種類',
        highlights: '重要な結論',
        itemCount: count => `成果物 ${count} 件`,
        kind: kind =>
          ({ copy: 'コピー', material: '素材', media: '素材', report: 'レポート', sheet: '表計算' })[kind] || kind,
        loadFailedDescription: '読み込みに失敗しました。会話の添付やモックデータで置き換えません。',
        loadFailedTitle: '成果物を利用できません',
        loadMore: 'さらに読み込む',
        loading: '成果物を読み込み中',
        loadingMore: '読み込み中…',
        material: '素材',
        noEvidence: '表示できる公開根拠はありません。',
        noReviews: 'レビュー記録はまだありません。',
        notVerified: '検証が必要',
        open: '成果を開く',
        openFailed: 'ファイルを開けませんでした。後でもう一度お試しください。',
        openUnavailable: '開けるファイルはありません',
        project: 'プロジェクト',
        refresh: '更新',
        report: 'レポート',
        requestChanges: '修正を依頼',
        reviewNote: '修正メモ',
        reviewNotePlaceholder: '変更点、根拠、期待する結果を入力',
        reviewNoteRequired: '修正メモを入力してください。',
        reviewRound: round => `第${round}回`,
        reviews: 'レビュー履歴',
        run: '関連する実行',
        sheet: '表計算',
        sourceCaptured: 'ソース取得日時',
        status: status =>
          ({
            approved: '承認済み',
        ...
        summary: '成果の概要',
        title: '成果物',
        unavailableDescription: 'この Desktop または本番 API では Phase 2 の読み取りが有効になっていません。',
        unavailableTitle: '実際の成果物に接続されていません',
        updated: '更新日時',
        verifier: '検証結果',
        verificationChecked: '確認日時',
        verificationOutcome: '検証結果',
        verificationReason: '検証メモ',
        verified: '検証済み',
        view: '詳細を見る',
        workflow: 'ワークフロー'
      },
      history: {
        all: 'すべて',
        deliverables: '成果',
        description: '実行、成果、判断を時系列で確認します。各項目は実際の対象にリンクします。',
        emptyDescription: '実際のワークフローが始まると、ライフサイクル記録がここに表示されます。',
        emptyTitle: '履歴はまだありません',
        eyebrow: '業務アクティビティ',
        filterEmpty: 'このフィルターに一致する履歴はありません。',
        filters: '履歴の種類',
        kind: kind => ({ deliverable: '成果', review: 'レビュー', run: '実行' })[kind] || kind,
        loadFailedDescription: '読み込みに失敗しました。会話検索で業務履歴を置き換えません。',
        loadFailedTitle: '履歴を利用できません',
        loadMore: 'さらに読み込む',
        loading: '履歴を読み込み中',
        loadingMore: '読み込み中…',
        noSummary: '追加の概要はありません。',
        older: '以前',
        open: '開く',
        recent: '過去7日',
        refresh: '更新',
        ...
        title: '履歴',
        today: '今日',
        unavailableDescription: 'この Desktop または本番 API では Activity の読み取りが有効になっていません。',
        unavailableTitle: '実際の履歴に接続されていません',
        yesterday: '昨日'
      },
      run: {
