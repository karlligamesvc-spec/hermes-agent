...
export const ar = defineLocale({
  ...
  commandCenter: {
    ...
    checkingDesktopUpdate: 'جار التحقق من التحديثات…',
    desktopUpdateReady: 'يتوفر تحديث لتطبيق APEX أو محرك الذكاء الاصطناعي.',
    desktopUpdatePreparing: 'جار تجهيز تحديث APEX…',
    desktopUpdateNeedsShell: 'يتطلب تحديث محرك الذكاء الاصطناعي إصدارا أحدث من تطبيق APEX.',
    desktopUpdateCheckFailed: 'تعذر التحقق من تحديث تطبيق APEX.',
    desktopUpToDate: 'تطبيق APEX ومحرك الذكاء الاصطناعي محدثان.',
  ...
  install: {
    ...
    failedDesc:
      'فشلت إحدى خطوات التثبيت. أغلق أي نسخ أخرى قيد التشغيل من Hermes CLI أو تطبيق سطح المكتب، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
