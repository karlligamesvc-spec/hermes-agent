...
type BotsMessages = {
  ...
  group: {
    newTitle: string
    createDescription: (max: number) => string
    minimumMembers: (available: number) => string
    addAssistant: string
...
const en: BotsMessages = {
  roster: {
    title: 'Assistants',
    search: 'Search assistants and group chats',
    searchPlaceholder: 'Search assistants and group chats…',
    newBotOrGroup: 'Add an assistant or create a group chat',
    ...
    emptyDesc: 'Add your first assistant.',
  ...
  bot: {
    newTitle: 'Add assistant',
    createAction: 'Add assistant',
    ...
    createFirstHint: 'Open the Assistants pane and select “Add assistant”.',
  ...
  group: {
    newTitle: 'Create group chat',
    createDescription: max => `Choose 2–${max} real assistants. Each assistant keeps its own profile and history.`,
    minimumMembers: available =>
      `A group chat needs at least 2 assistants. ${available === 1 ? 'Only 1 is available right now.' : 'None are available right now.'}`,
    addAssistant: 'Add assistant',
    noMatch: query => `No assistants match “${query}”`,
    noAssistants: 'No assistants yet — add one first.',
    pickAtLeastTwo: 'Choose at least 2 assistants',
    createAction: count => `Create group chat${count ? ` (${count})` : ''}`,
...
const ja: BotsMessages = {
  ...
  group: {
    newTitle: 'グループチャットを作成',
    createDescription: max => `2〜${max}人の実在するアシスタントを選択します。各アシスタントのプロファイルと履歴は保持されます。`,
    minimumMembers: available =>
      `グループチャットには2人以上のアシスタントが必要です。現在利用できるのは${available}人です。`,
    addAssistant: 'アシスタントを追加',
    noMatch: query => `「${query}」に一致するアシスタントはいません`,
    noAssistants: 'アシスタントはまだいません。先に追加してください。',
    pickAtLeastTwo: '2人以上のアシスタントを選択してください',
    createAction: count => `グループチャットを作成${count ? `（${count}）` : ''}`,
...
const zh: BotsMessages = {
  roster: {
    title: '助手',
    search: '搜索助手和群聊',
    searchPlaceholder: '搜索助手和群聊…',
    newBotOrGroup: '添加助手或创建群聊',
    activityToastsOn: '活动通知已开启 — 点按关闭',
    activityToastsOff: '活动通知已关闭 — 点按开启',
    groupChats: '群聊',
    emptyTitle: '还没有助手',
    emptyDesc: '添加你的第一个助手。',
    noMatchQuery: query => `没有助手或群聊匹配“${query}”`,
    noMatchQueryOn: (query, gateway) => `${gateway} 上没有助手或群聊匹配“${query}”`,
    noMatchFiltersOn: gateway => `${gateway} 上没有助手或群聊匹配这些筛选条件`,
    noMatchFilters: '没有助手或群聊匹配这些筛选条件。',
    clearFilters: '清除筛选',
    allHidden: '所有助手都已隐藏',
    allHiddenDesc: '它们会继续运行，并保留各自的历史。',
    showHidden: '显示已隐藏的助手',
    noHiddenMatch: '没有已隐藏的助手匹配这些筛选条件。',
  ...
  sections: {
    ...
    headingTip: '将助手拖放到此处 · 双击重命名',
    emptyHint: '将助手拖到此处',
    moveTo: '移动到分区',
    newSectionEllipsis: '新建分区…',
    removeFromSection: '移出分区',
    deleted: (name, count) => (count === 0 ? `已删除“${name}”` : `已删除“${name}” — ${count} 个助手已移至未分类`),
    undo: '撤销'
  },
  bot: {
    newTitle: '添加助手',
    ...
    editTitle: '编辑配置档案',
    editMenu: '编辑…',
    helpPromptPlaceholder: '这个助手应该帮你做什么？',
    descriptionHint: '留空则根据助手的名称和描述生成。',
    newChatWith: '与此助手开新聊天',
    openBotChat: '打开助手聊天',
    duplicate: '复制',
    duplicateFailed: '复制失败',
    deleteTitle: '删除助手和配置档案？',
    removeFromAllGroups: '从所有群组中移除',
    createFirstHint: '打开助手面板，点击“添加助手”。',
    createFailed: '暂时无法创建配置档案',
    advanced: '高级',
    advancedHint: '高级 — 模型、技能、工具集、SOUL.md',
    advancedFailed: '高级配置失败',
    openAnotherChatUnsupported: '请更新 Hermes Desktop 以打开另一个助手聊天。',
    remoteConnectionsUnsupported: '请更新 Hermes Desktop 以与其他连接上的助手聊天。',
    chatEmpty: '说点什么开始吧。',
    kickoff: '你好，介绍一下你自己吧！'
  },
  avatar: {
    classicShapes: '经典形状',
    blobFromName: '斑点脸 — 根据助手名称绘制',
    unlockFollowsName: '解锁 — 面孔再次跟随助手名称',
    randomize: '随机',
    tabBot: '助手',
    tabGenerate: '生成',
    upload: '上传',
  ...
  group: {
    newTitle: '创建群聊',
    createDescription: max => `选择 2–${max} 个真实助手。每个助手保留自己的配置和历史。`,
    minimumMembers: available => `创建群聊至少需要 2 个助手。当前只有 ${available} 个可用助手。`,
    addAssistant: '添加助手',
    noMatch: query => `没有助手匹配“${query}”`,
    noAssistants: '还没有助手，请先添加。',
    pickAtLeastTwo: '至少选择 2 个助手',
    createAction: count => `创建群聊${count ? `（${count}）` : ''}`,
    manageDesc: '一个助手可以加入多个群聊。成员关系会同步到每台设备。',
    manageTitle: '管理群组',
    settingsTitle: '群组设置',
    settingsDesc: '重命名群组或设置房间图片。成员和历史都会保留。',
    nameLabel: '群组名称',
    searchToAdd: '搜索要添加的助手',
    searchToAddPlaceholder: '搜索要添加的助手…',
    removeFromSelection: '从选择中移除',
    disbandTitle: '解散群聊？',
    deleteTitle: '删除群聊？',
    deleteAction: '删除',
    composerPlaceholder: '说点什么 — 这个群里的每个助手都会听到。',
    slashCommandsUnsupported: '群聊不支持斜杠命令。请打开单个助手聊天来使用。',
    attachHint: '附加文件 — 每个回应的助手都能看到',
    newThread: '新帖子',
    reply: '回复',
    ...
    allHeldStatus: count => `全部 ${count} 个助手已暂停`,
    heldMembersStatus: members => `已暂停：${members}`,
    holdReleaseHint: '提及已暂停的助手，或发送 @all resume 以恢复它们。',
    needsYourInput: '此群聊中有助手需要你输入',
    pictureGenerationFailed: '群组图片生成失败',
    nameTaken: name => `已存在名为“${name}”的群聊。`,
    memberCount: count => `${count} 个助手`,
  ...
  cron: {
    filterHint:
      '此配置档案中有定时任务，但没有一个标记给这个助手。将任务命名为“[bot:<名称>] …”即可显示在这里，也可以在下方的 Cron 中查看。',
    needsRosterFirst: '这个助手需要先出现在名册中。',
    ...
    botChatTarget: bot => `${bot} 的聊天（助手会回应）`,
...
const zhHant: BotsMessages = {
  roster: {
    title: '助手',
    search: '搜尋助手和群組聊天',
    searchPlaceholder: '搜尋助手和群組聊天…',
    newBotOrGroup: '新增助手或建立群組聊天',
    activityToastsOn: '活動通知已開啟 — 點按關閉',
    activityToastsOff: '活動通知已關閉 — 點按開啟',
    groupChats: '群組聊天',
    emptyTitle: '還沒有助手',
    emptyDesc: '新增你的第一個助手。',
    noMatchQuery: query => `沒有助手或群組聊天符合「${query}」`,
    noMatchQueryOn: (query, gateway) => `${gateway} 上沒有助手或群組聊天符合「${query}」`,
    noMatchFiltersOn: gateway => `${gateway} 上沒有助手或群組聊天符合這些篩選條件`,
    noMatchFilters: '沒有助手或群組聊天符合這些篩選條件。',
    clearFilters: '清除篩選',
    allHidden: '所有助手都已隱藏',
    allHiddenDesc: '它們會繼續運作，並保留各自的歷史。',
    showHidden: '顯示已隱藏的助手',
    noHiddenMatch: '沒有已隱藏的助手符合這些篩選條件。',
    hiddenFromRoster: '已從名單中隱藏',
    pinned: '已釘選',
    needsAttention: '需要處理',
    needsInput: '需要您的輸入',
    botsAndGroups: '助手和群組聊天',
    botsOnly: '僅助手',
    groupsOnly: '僅群組聊天',
    anyActivity: '任何活動',
    activeNow: '目前活躍',
  ...
  sections: {
    ...
    headingTip: '將助手拖放到此處 · 雙擊重新命名',
    emptyHint: '將助手拖到此處',
    moveTo: '移動到分區',
    newSectionEllipsis: '新增分區…',
    removeFromSection: '移出分區',
    deleted: (name, count) => (count === 0 ? `已刪除「${name}」` : `已刪除「${name}」— ${count} 個助手已移至未分類`),
    undo: '復原'
  },
  bot: {
    newTitle: '新增助手',
    ...
    editTitle: '編輯設定檔',
    editMenu: '編輯…',
    helpPromptPlaceholder: '這個助手應該幫你做什麼？',
    descriptionHint: '留空則依助手的名稱和描述產生。',
    newChatWith: '與此助手開新聊天',
    openBotChat: '開啟助手聊天',
    duplicate: '複製',
    duplicateFailed: '複製失敗',
    deleteTitle: '刪除助手和設定檔？',
    removeFromAllGroups: '從所有群組中移除',
    createFirstHint: '開啟助手面板，點「新增助手」。',
    createFailed: '暫時無法建立設定檔',
    advanced: '進階',
    advancedHint: '進階 — 模型、技能、工具集、SOUL.md',
    advancedFailed: '進階設定失敗',
    openAnotherChatUnsupported: '請更新 Hermes Desktop 以開啟另一個助手聊天。',
    remoteConnectionsUnsupported: '請更新 Hermes Desktop 以與其他連線上的助手聊天。',
    chatEmpty: '說點什麼開始吧。',
    kickoff: '你好，介紹一下你自己吧！'
  },
  avatar: {
    classicShapes: '經典形狀',
    blobFromName: '斑點臉 — 依助手名稱繪製',
    unlockFollowsName: '解鎖 — 面孔再次跟隨助手名稱',
    randomize: '隨機',
    tabBot: '助手',
    tabGenerate: '生成',
    upload: '上傳',
  ...
  group: {
    newTitle: '建立群組聊天',
    createDescription: max => `選擇 2–${max} 個真實助手。每個助手都會保留自己的設定與歷史。`,
    minimumMembers: available => `建立群組聊天至少需要 2 個助手。目前只有 ${available} 個可用助手。`,
    addAssistant: '新增助手',
    noMatch: query => `沒有助手符合「${query}」`,
    noAssistants: '還沒有助手，請先新增。',
    pickAtLeastTwo: '至少選擇 2 個助手',
    createAction: count => `建立群組聊天${count ? `（${count}）` : ''}`,
    manageDesc: '一個助手可以加入多個群組聊天。成員關係會同步到每台裝置。',
    manageTitle: '管理群組',
    settingsTitle: '群組設定',
    settingsDesc: '重新命名群組或設定房間圖片。成員和歷史都會保留。',
    nameLabel: '群組名稱',
    searchToAdd: '搜尋要加入的助手',
    searchToAddPlaceholder: '搜尋要加入的助手…',
    removeFromSelection: '從選取中移除',
    disbandTitle: '解散群組聊天？',
    deleteTitle: '刪除群組聊天？',
    deleteAction: '刪除',
    composerPlaceholder: '說點什麼 — 這個群組裡的每個助手都會聽到。',
    slashCommandsUnsupported: '群組聊天不支援斜線命令。請開啟個別助手聊天來使用。',
    attachHint: '附加檔案 — 每個回應的助手都能看到',
    newThread: '新討論串',
    reply: '回覆',
    ...
    allHeldStatus: count => `全部 ${count} 個助手已暫停`,
    heldMembersStatus: members => `已暫停：${members}`,
    holdReleaseHint: '提及已暫停的助手，或傳送 @all resume 以恢復它們。',
    needsYourInput: '此群組聊天中有助手需要您的輸入',
    pictureGenerationFailed: '群組圖片產生失敗',
    nameTaken: name => `已存在名為「${name}」的群組聊天。`,
    memberCount: count => `${count} 個助手`,
  ...
  cron: {
    filterHint:
      '此設定檔中有排程工作，但沒有任何一個標記給這個助手。將工作命名為「[bot:<名稱>] …」即可顯示在這裡，也可以在下方的 Cron 中查看。',
    needsRosterFirst: '這個助手需要先出現在名冊中。',
    ...
    botChatTarget: bot => `${bot} 的聊天（助手會回應）`,
