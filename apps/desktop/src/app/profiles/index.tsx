...
import { AlertTriangle, Pencil, Terminal, Trash2, Users } from '@/lib/icons'
...
// SOUL.md editing moved to settings (设置 → 个性化 embeds it for the active
// profile); this page keeps a per-profile instance for profile management.
import { SoulEditor } from '../settings/soul-editor'
