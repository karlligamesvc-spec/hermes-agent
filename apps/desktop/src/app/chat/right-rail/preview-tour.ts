...
// driver.js 1.8 ships this browser bundle but no longer exports its deep
// package path. The Desktop build is rooted at the monorepo install, so use
// the physical workspace-relative file and let Vite's raw loader consume it
// without crossing the package-exports boundary.
