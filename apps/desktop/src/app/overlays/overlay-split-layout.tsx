...
// Quiet "new …" affordance that sits above an overlay rail's nav list (任务 /
// 场景): a ghost row rather than a filled button, so it reads as one more item
// in the rail instead of competing with the page's primary action.
