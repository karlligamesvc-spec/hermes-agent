...
// APEX composer compatibility: the pre-v0.21 shell exposed this helper as
// toggleSkill. Keep that stable name while the upstream API module uses the
// more explicit setSkillEnabled name.
export const toggleSkill = setSkillEnabled
