...
def _stage_windows_node_zip(home: Path, node_arch: str) -> Path | None:
    ...
    # APEX China deployments inject the npmmirror base; upstream/default
    # installs keep using nodejs.org.
    node_dist_base = (
        os.environ.get("HERMES_NODE_DIST_BASE") or "https://nodejs.org/dist"
    ).rstrip("/")
