...
AUTHOR_MAP = {
    "karlligamesvc@gmail.com": "karlligamesvc-spec",  # fork owner seat identity (hc-474: first stacked PR made contributor-check walk our own base-branch commits and demand the mapping)
