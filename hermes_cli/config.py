...
DEFAULT_CONFIG = {
    ...
    "auxiliary": {
        ...
        # MoA reference + aggregator auxiliary call timeouts/overrides. "auto"
        # (default) routes each MoA slot through resolve_runtime_provider (so a
        # custom/relay slot uses its configured base_url + key). 600s timeout
        # because reference fan-out + aggregator synthesis can be long.
        "moa_reference": {
            "provider": "auto",
            "model": "",
            "base_url": "",
