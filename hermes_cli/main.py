...
def _desktop_packaged_executable(desktop_dir: Path) -> Optional[Path]:
    ...
    if sys.platform == "darwin":
        candidates = list(release_dir.glob("mac*/APEX.app/Contents/MacOS/APEX"))
        candidates += list(release_dir.glob("mac*/Hermes.app/Contents/MacOS/Hermes"))
    elif sys.platform == "win32":
        candidates = [
            release_dir / "win-unpacked" / "APEX.exe",
            release_dir / "win-ia32-unpacked" / "APEX.exe",
            release_dir / "win-arm64-unpacked" / "APEX.exe",
        ...
        candidates = [
            release_dir / "linux-unpacked" / "APEX",
            release_dir / "linux-unpacked" / "hermes",
            release_dir / "linux-unpacked" / "Hermes",
            release_dir / "linux-arm64-unpacked" / "APEX",
