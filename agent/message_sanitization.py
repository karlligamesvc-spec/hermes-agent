...
def _repair_tool_call_arguments(raw_args: str, tool_name: str = "?") -> str:
    ...
    # Last resort: replace with empty object so the API request doesn't crash
    # the entire session. Preserve enough bounded head/tail context to diagnose
    # truncation without copying a potentially huge or secret-bearing payload
    # into logs.
    logger.warning(
